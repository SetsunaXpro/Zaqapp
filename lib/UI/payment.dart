...
import 'package:zaqapp/services/firestore_service.dart';
    ...
    return Column(
      ...
      children: [
        ...
        if (ZakatState.fitrahAmount > 0)
          _optionTile(
            title: 'Zakat Fitrah',
            subtitle: 'Rp ${ZakatState.fitrahAmount.toStringAsFixed(0)}',
            onTap: () => _selectSaved(ZakatState.fitrahAmount, 'Fitrah'),
          ),
        ...
        if (ZakatState.maalAmount > 0)
          _optionTile(
            ...
            onTap: () => _selectSaved(ZakatState.maalAmount, 'Maal'),
          ),
    ...
    return Column(
      children: [
        ...
        ElevatedButton(
          ...
          onPressed: () async {
            if (_amount <= 0 || _type.isEmpty) return;
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text("Transaksi berhasil dibuat (Pending)"),
              ),
            );
          },
